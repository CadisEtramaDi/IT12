                ...
                <tbody>
                    @forelse($payments as $payment)
                        <tr class="border-b border-gray-100 hover:bg-gray-50">
                            ...
                            <td class="py-3 px-4">
                                <a href="{{ route('admin.bookings.show', $payment->bookingID) }}" class="text-[#0EA5E9] hover:underline font-medium">
                                    #{{ $payment->bookingID }}
                                </a>
                            </td>
                            ...
                            <td class="py-3 px-4 text-green-600 font-semibold">₱{{ number_format($payment->amountpaid, 2) }}</td>
